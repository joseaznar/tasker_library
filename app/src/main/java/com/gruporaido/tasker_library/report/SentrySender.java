...
package com.gruporaido.tasker_library.report;
...
public class SentrySender implements ReportSender {
    ...
    public static final ReportField[] SENTRY_TAGS_FIELDS = {APP_VERSION_CODE, APP_VERSION_NAME,
            PACKAGE_NAME, FILE_PATH, PHONE_MODEL, BRAND, PRODUCT, ANDROID_VERSION, IS_SILENT, INSTALLATION_ID};

    public static final ReportField[] SENTRY_EXTRA_FIELDS = {TOTAL_MEM_SIZE, AVAILABLE_MEM_SIZE, IS_SILENT,
            USER_APP_START_DATE, USER_CRASH_DATE, SHARED_PREFERENCES, LOGCAT, USER_EMAIL, USER_COMMENT, SETTINGS_GLOBAL, DISPLAY};
    ...
    public void send(CrashReportData errorContent) throws ReportSenderException {
        ...
        headers.put("X-Sentry-Token", "3d26645a1c8a11e5b8d70025902db334");
...
/*    	X-Sentry-Auth: Sentry sentry_version=3,
    ...
    private String buildJSON(CrashReportData report) throws JSONException {
        ...
        if (ACRA.getConfig().customReportContent().length > 0) {
            ...
            obj.put("extra", remap(report, SENTRY_EXTRA_FIELDS));
        }
    ...
    /**
     * Builds the stacktrace into a string.
     *
     * @param exception exception
     * @return the stacktrace
     */
    /*private String buildStacktrace(Throwable exception) {
        Throwable cause = exception;
